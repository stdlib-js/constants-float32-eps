...
```javascript
FLOAT32_EPS = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-eps@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-eps/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/constants-float32-eps/actions/workflows/test.yml?query=branch:v0.2.0
